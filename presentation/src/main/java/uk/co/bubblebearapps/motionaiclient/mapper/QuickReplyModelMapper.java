...
public class QuickReplyModelMapper {
    ...
    public QuickReplyModelsList map(List<QuickReply> quickReplies, DateTime timeStamp) {
        ...
        return new QuickReplyModelsList(UUID.randomUUID().toString(), timeStamp, result);
