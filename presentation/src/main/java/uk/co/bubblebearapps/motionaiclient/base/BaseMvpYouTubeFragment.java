...
/**
 */
public abstract class BaseMvpYouTubeFragment<P extends BasePresenter<V>, V extends BaseView> extends YouTubePlayerSupportFragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        getLoaderManager().initLoader(loaderId(), null, new LoaderManager.LoaderCallbacks<P>() {
            ...
            public final void onLoadFinished(Loader<P> loader, P presenter) {
                BaseMvpYouTubeFragment.this.presenter = presenter;
                onPresenterPrepared(presenter);
            }

            @Override
            public final void onLoaderReset(Loader<P> loader) {
                BaseMvpYouTubeFragment.this.presenter = null;
